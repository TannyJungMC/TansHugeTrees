...
public class TannyPackManager {
    ...
    public static boolean checkUpdate (ServerLevel level_server, Logger logger, String path_config, String id, String pack_link, String branch, String wiki, int data_structure_version, boolean auto_update, String command_update) {
        ...
        if (OutsideUtils.isURLAvailable(url) == false) {
            ...
            int pack_version = 0;
            File file_pack = getCurrentFile(path_config);

            // Get Version Offline
            {

                File file = new File(path_config + "/#dev/temporary/info/" + file_pack.getName() + ".txt");
            ...
            if (url_data_structure_version == 0) {
                ...
                if (level_server != null) {
                    ...
                    logger.error("Something went wrong with version testing. This maybe the website is currently down or there's a new mod update. The most serious case is your country blocked GitHub website, that will need to manual install with VPN enabled. Here is installation wiki if you want to manual install ({}).", wiki);
                ...
                } else if (data_structure_version > url_data_structure_version) {
            ...
            logger.info("Data Structure Version -> Mod {} GitHub {} / Pack Version -> Mod {} GitHub {}", data_structure_version, url_data_structure_version, pack_version, url_pack_version);

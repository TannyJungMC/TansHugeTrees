				...
				try {
					...
					if (pack_version == url_pack_version) {
						...
						if (mod_version == Handcode.mod_version) {
							...
							GameUtils.sendChatMessage(level, "@a", "gold", "THT : Seems like you update the mod very fast! TannyJung's Tree Pack (" + Handcode.tanny_pack_version_name + ") haven't updated to support this mod version yet, please wait a bit.");

...
public class ConfigMain {
	...
	public static void repair () {
...

		{
			...
			pre_leaf_litter_chance_coniferous = 0.1
			...
			living_tree_mechanics_simulation = 50
			...
			leaf_litter_remover_count_limit = 10
	...
	public static void apply (LevelAccessor level) {
		...
		rt_dynamic = Get.logic("living_tree_mechanics");
		rt_dynamic_tick = Get.numberInt("living_tree_mechanics_tick");

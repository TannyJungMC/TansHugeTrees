	...
	public static void repair () {
...

		{
			...
			write.append("""
					...
					| Create leaf litter on ground and water while world generation. For normal and coniferous leaves.
					| Default is 0.25 / 0.1
					...
					| List of coniferous leaves blocks. Coniferous is pine trees. They will drop their leaves only in summer, and almost rare.
					| Default is minecraft:spruce_leaves

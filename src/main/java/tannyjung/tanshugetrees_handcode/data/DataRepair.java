...
public class DataRepair {
    ...
    public static void runCustomPack () {
    ...
    public static void messagePackErrors (ServerLevel level_server, String type) {
        ...
        if (type.contains("pack") == true) CustomPackOrganizing.sendErrorMessage(level_server, cache_pack_errors, "THT", "pack");
        if (type.contains("file") == true) CustomPackOrganizing.sendErrorMessage(level_server, cache_pack_errors, "THT", "file");

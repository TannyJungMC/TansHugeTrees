package tannyjung.tanshugetrees_handcode.client;
        ...
        // World Loading
        {
            ...
            if (event.getScreen() instanceof LevelLoadingScreen) {
                ...
                if (TreeLocation.world_gen_overlay_animation != 0) {
                    ...
                    OverlayMaker.image(graphic, "inside", "", "tanshugetrees:textures/screens/overlay_region_gen.png", 6, 8, 64, 16, 4, 1, (int) OVERLAYWorldGenAnimationProcedure.execute());
                    OverlayMaker.image(graphic, "inside", "", "tanshugetrees:textures/screens/overlay_region_gen_bar.png", 22, 8, 17, 16, 17, 1, (int) OVERLAYWorldGenBarProcedure.execute());

...
public class Seasons {
    ...
    public static void get (ServerLevel level_server) {
        ...
        Utils.misc.sendChatMessage(level_server, "@a", "gray", "THT : Current Season is " + TanshugetreesModVariables.MapVariables.get(level_server).season);

    }

    public static void set (ServerLevel level_server, String season) {

        Utils.misc.sendChatMessage(level_server, "@a", "gray", "THT : Set Season To " + season);

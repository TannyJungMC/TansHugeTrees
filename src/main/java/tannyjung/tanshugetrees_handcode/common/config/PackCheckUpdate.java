package tannyjung.tanshugetrees_handcode.common.config;
    ...
    public static void start (LevelAccessor level_accessor, boolean up_to_date_message) {
		...
		if (level_accessor instanceof ServerLevel level_server) {
            ...
            if (OutsideUtils.isURLAvailable("https://github.com/TannyJungMC") == false) {
                ...
                Utils.misc.sendChatMessage(level_server, "@a", "red", "THT : Can't do auto install right now, as the mod can't connect to GitHub.");

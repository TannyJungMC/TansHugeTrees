...
public class ConfigRepairPlacement {
    ...
    private static void clear (LevelAccessor world, double x, double y, double z) throws Exception {
		...
		filebw = new BufferedWriter(filewriter);
            ...
            filebw.newLine();
            filebw.write("- biome is biome the tree can generate. Not supported biome tags, but can use multiple biomes.");
            filebw.newLine();
            filebw.write("- ground_block is block that tree can generate on it. Not supported block tags, but can use multiple blocks.");
            filebw.newLine();
            ...
            filebw.newLine();
            filebw.write("- min_distance is the max distance of trees in blocks from the same species. Higher number make it more rare. Only work when the chunks around the one is loading.");
            filebw.newLine();
            filebw.write("- group_chance is a chance for trees to spawn nearby other in the same species, work good for bush and trees in plains. Only supported number between 0 to 1.");
            filebw.newLine();

        ...
        if (file.exists() == true) {
	        ...
	        try {
				...
				if (pack_version.equals(url_pack_version) == true) {
					...
					if (
						ThtModVariables.MapVariables.get(world).auto_check_update == true &&
						ThtModVariables.MapVariables.get(world).auto_update == true
						) {
	
							if (world instanceof ServerLevel _level) {
								_level.getServer().getCommands().performPrefixedCommand(new CommandSourceStack(CommandSource.NULL,new Vec3(x, y, z), Vec2.ZERO, _level, 4, "",Component.literal(""), _level.getServer(), null).withSuppressedOutput(),("tellraw @a [{\"text\":\"THT : Detected new version for TannyJung's Tree Pack. Starting auto update, please wait a moment.\",\"color\":\"gold\"}]"));
							...
							if (world instanceof ServerLevel _level) {
				            	_level.getServer().getCommands().performPrefixedCommand(new CommandSourceStack(CommandSource.NULL,new Vec3(x, y, z), Vec2.ZERO, _level, 4, "",Component.literal(""), _level.getServer(), null).withSuppressedOutput(),("tellraw @a [{\"text\":\"THT : Detected new version for TannyJung's Tree Pack. You can manual download on \",\"color\":\"gold\"},{\"text\":\"GitHub\",\"color\":\"white\",\"underlined\":\"true\",\"clickEvent\":{\"action\":\"open_url\",\"value\":\"https://github.com/TannyJungMC/THT-tree_pack\"}},{\"text\":\" or click \",\"color\":\"gold\"},{\"text\":\"[here]\",\"color\":\"white\",\"clickEvent\":{\"action\":\"run_command\",\"value\":\"/THT tanny_pack update\"}},{\"text\":\" to auto update.\",\"color\":\"gold\"}]"));
							}
			...
			if (world instanceof ServerLevel _level) {
            	_level.getServer().getCommands().performPrefixedCommand(new CommandSourceStack(CommandSource.NULL,new Vec3(x, y, z), Vec2.ZERO, _level, 4, "",Component.literal(""), _level.getServer(), null).withSuppressedOutput(),("tellraw @a [{\"text\":\"THT : Not detected TannyJung's Tree Pack in the mod config. You can manual download on \",\"color\":\"gold\"},{\"text\":\"GitHub\",\"color\":\"white\",\"underlined\":\"true\",\"clickEvent\":{\"action\":\"open_url\",\"value\":\"https://github.com/TannyJungMC/THT-tree_pack\"}},{\"text\":\" or click \",\"color\":\"gold\"},{\"text\":\"[here]\",\"color\":\"white\",\"clickEvent\":{\"action\":\"run_command\",\"value\":\"/THT tanny_pack update\"}},{\"text\":\" to auto download and install.\",\"color\":\"gold\"}]"));
			}

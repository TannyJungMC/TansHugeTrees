					...
					for (int index0 = 0; index0 < 100; index0++) {
						...
						if (loop != loop_next) {
							...
							if (!(type).equals("leaves")) {
								if (true) {
									if (true) {
										file_write = ("@" + type_short + "o = ") + "" + entity.getPersistentData().getString((type + "_outer"));
										if (entity.getPersistentData().getBoolean((type + "_replace")) == false) {
											if (!file_write.endsWith("= ")) {
												{
													filebw.write((file_write + " replace #tht:passable_blocks"));
													filebw.newLine();
												}
											}
										}
									...
									if (true) {
										file_write = ("@" + type_short + "i = ") + "" + entity.getPersistentData().getString((type + "_inner"));
										if (entity.getPersistentData().getBoolean((type + "_replace")) == false) {
											if (!file_write.endsWith("= ")) {
												{
													filebw.write((file_write + " replace #tht:passable_blocks"));
									...
									if (true) {
										file_write = ("@" + type_short + "c = ") + "" + entity.getPersistentData().getString((type + "_core"));
										if (entity.getPersistentData().getBoolean((type + "_replace")) == false) {
											if (!file_write.endsWith("= ")) {
												{
													filebw.write((file_write + " replace #tht:passable_blocks"));
								...
								if (true) {
									if (true) {
										file_write = ("@" + type_short + "1 = ") + "" + entity.getPersistentData().getString("leaves");
										if (entity.getPersistentData().getBoolean((type + "_replace")) == false) {
											if (!file_write.endsWith("= ")) {
												{
													filebw.write((file_write + " replace #tht:passable_blocks"));
									...
									if (true) {
										file_write = ("@" + type_short + "2 = ") + "" + entity.getPersistentData().getString("leaves2");
										if (entity.getPersistentData().getBoolean((type + "_replace")) == false) {
											if (!file_write.endsWith("= ")) {
												{
													filebw.write((file_write + " replace #tht:passable_blocks"));

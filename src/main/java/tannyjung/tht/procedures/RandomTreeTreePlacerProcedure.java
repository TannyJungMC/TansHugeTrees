			...
			if (entity.getPersistentData().getBoolean("skip") == false) {
				...
				try {
					...
					while ((stringiterator = fileReader.readLine()) != null) {
						if (ThtModVariables.MapVariables.get(world).world_hight_limit != 0) {
					...
					while ((stringiterator = fileReader.readLine()) != null) {
						...
						if (entity.getPersistentData().getBoolean("skip") == false) {
							if (stringiterator.contains("--------------------------------------------------")) {
								...
								if (true) {
									if (stringiterator.contains("tree_type : ")) {
										if ((stringiterator.substring((int) ("tree_type : ").length())).equals("land")) {
											if ((world.getBlockState(new BlockPos(entity.getX(), entity.getY(), entity.getZ()))).getBlock() == Blocks.WATER
													|| ("minecraft:kelp_plant" + "minecraft:seagrass" + "minecraft:tall_seagrass")
															.contains(ForgeRegistries.BLOCKS.getKey((world.getBlockState(new BlockPos(entity.getX(), entity.getY(), entity.getZ()))).getBlock()).toString())
													|| (world.getBlockState(new BlockPos(entity.getX(), entity.getY(), entity.getZ()))).getBlock().getStateDefinition().getProperty("waterlogged") instanceof BooleanProperty _getbp87
															&& (world.getBlockState(new BlockPos(entity.getX(), entity.getY(), entity.getZ()))).getValue(_getbp87)) {
											...
											if (!((world.getBlockState(new BlockPos(entity.getX(), entity.getY(), entity.getZ()))).getBlock() == Blocks.WATER
													|| ("minecraft:kelp_plant" + "minecraft:seagrass" + "minecraft:tall_seagrass")
															.contains(ForgeRegistries.BLOCKS.getKey((world.getBlockState(new BlockPos(entity.getX(), entity.getY(), entity.getZ()))).getBlock()).toString())
													|| (world.getBlockState(new BlockPos(entity.getX(), entity.getY(), entity.getZ()))).getBlock().getStateDefinition().getProperty("waterlogged") instanceof BooleanProperty _getbp104
															&& (world.getBlockState(new BlockPos(entity.getX(), entity.getY(), entity.getZ()))).getValue(_getbp104))) {
												entity.getPersistentData().putBoolean("dead_tree", true);
											}
										}
									}
								...
								if (stringiterator.contains("start_height : ")) {
									...
									if (ThtModVariables.MapVariables.get(world).world_hight_limit != 0) {
										if (entity.getY() + entity.getPersistentData().getDouble("highest_block") > ThtModVariables.MapVariables.get(world).world_hight_limit) {
											{
												Entity _ent = entity;
												if (!_ent.level.isClientSide() && _ent.getServer() != null) {
													_ent.getServer().getCommands().performPrefixedCommand(new CommandSourceStack(CommandSource.NULL, _ent.position(), _ent.getRotationVector(),
				...
				try {
					...
					String stringiterator = "";
					while ((stringiterator = fileReader.readLine()) != null) {
						if (ThtModVariables.MapVariables.get(world).tree_placer_process_limit == 0
							...
							if (entity.getPersistentData().getBoolean("skip2") == false) {
								...
								if (stringiterator.contains("^")) {
									if (!(stringiterator.contains("@le") && entity.getPersistentData().getDouble("dead_tree_level") >= 1 || stringiterator.contains("@lt") && entity.getPersistentData().getDouble("dead_tree_level") >= 2
											|| stringiterator.contains("@tw") && entity.getPersistentData().getDouble("dead_tree_level") >= 3 || stringiterator.contains("@br") && entity.getPersistentData().getDouble("dead_tree_level") >= 4)) {
										...
										if (!((stringiterator.contains("@tri") || stringiterator.contains("@trc")) && entity.getPersistentData().getDouble("dead_tree_level") >= 5)) {
											if (!(stringiterator.contains("@ta") || stringiterator.contains("@se") || stringiterator.contains("@te") || stringiterator.contains("@fi")) || ThtModVariables.MapVariables.get(world).world_gen_roots == true
													|| entity.getPersistentData().getBoolean("can_disable_roots") == false) {
												if (true) {
													command = "";
													pos = "";
													end_text = "";
												...
												if (entity.getPersistentData().getBoolean("rt_dynamic") == true) {
													if (stringiterator.contains("@le") && end_text.contains("[persistent=true]")) {
														...
														if (ForgeRegistries.BLOCKS.getValue(new ResourceLocation((end_text).toLowerCase(java.util.Locale.ENGLISH))).defaultBlockState().is(BlockTags.create(new ResourceLocation("tht:leaves_blocks")))) {
						...
						if (ThtModVariables.MapVariables.get(world).tree_placer_process_limit > 0) {
							if (entity.getPersistentData().getDouble("process") > entity.getPersistentData().getDouble("process_save") + ThtModVariables.MapVariables.get(world).tree_placer_process_limit) {
								break;
							}
							...
							if (!_ent.level.isClientSide() && _ent.getServer() != null) {
								_ent.getServer().getCommands()
										.performPrefixedCommand(
												...
												("data merge entity @s {CustomName:'{\"text\":\"THT-" + "" + entity.getPersistentData().getString("tree_name") + "\"}',Tags:[\"THT-tree_location\"]}"));
							}
						}
					} else {
						{

	...
	public interface MenuAccessor {
		...
		default void sendMenuStateUpdate(Player player, int elementType, String name, Object elementState, boolean needClientUpdate) {
			...
			if (player instanceof ServerPlayer serverPlayer) {
				PacketDistributor.sendToPlayer(serverPlayer, new tannyjung.tanshugetrees.network.MenuStateUpdatePayload(elementType, name, elementState));
				...
				PacketDistributor.sendToServer(new tannyjung.tanshugetrees.network.MenuStateUpdatePayload(elementType, name, elementState));
			}
		}

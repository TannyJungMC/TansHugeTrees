...
public class TanshugetreesModMenus {
	...
	public static final RegistryObject<MenuType<TreeSummonerStaffGUIMenu>> TREE_SUMMONER_STAFF_GUI = REGISTRY.register("tree_summoner_staff_gui", () -> IForgeMenuType.create(TreeSummonerStaffGUIMenu::new));
